...
namespace IPS.Common
{
    public class CommonValue
    {
        ...
        public const string ONTOLOGYTOC = "OntologyTOC";

        //public const string SERVICE_MANAGEMENT = "服務管理";
        //public const string DATA_ACQUISITION = "資料蒐集";
        //public const string MODEL_CREATION = "建立模型";
        //public const string MODEL_MANAGEMENT = "ModelManagement";
        //public const string USER_MANAGEMENT = "UserManagement";
        //public const string ONTOLOGY = "Ontology";
        //public const string ONTOLOGYTOC = "OntologyTOC";
